    ...
    <section className="section" id="who-pays">
      <div className="section-head">
        ...
        <p className="section-sub">
          A red team that signs its own cheques is a fraud generator. So the role that{" "}
          <strong>finds</strong> and the role that <strong>pays</strong> are split across separate
          keys in separate containers — with independent verifiers wedged between them.
        </p>
      </div>
